'use strict';
var wrap_callback = require('../vendor/longjohn').wrap_callback;
...
Promise.prototype.onFulfill = function (fn) {
  ...
  fn = wrap_callback(fn, 'Promise.onFulfill');
...
Promise.prototype.onReject = function (fn) {
  if (!fn) return this;
  if ('function' != typeof fn) throw new TypeError("fn should be a function");
  fn = wrap_callback(fn, 'Promise.onReject');
...
Promise.prototype.onResolve = function (fn) {
  ...
  if (!fn) return this;
  if ('function' != typeof fn) throw new TypeError("fn should be a function");
  fn = wrap_callback(fn, 'Promise.onResolve');
...
Promise.prototype.then = function (onFulfill, onReject) {
  ...
  if ('function' == typeof onFulfill) {
    onFulfill = wrap_callback(onFulfill, 'Promise.then');
  ...
  if ('function' == typeof onReject) {
    onReject = wrap_callback(onReject, 'Promise.then');
